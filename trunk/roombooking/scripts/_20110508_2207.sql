...
ALTER TABLE `booking`.`booking` CHANGE COLUMN `discount_id` `discount` DOUBLE  DEFAULT NULL,
 DROP FOREIGN KEY `booking_fk_constraint10`;

ALTER TABLE `booking`.`booking` ADD COLUMN `commission` DOUBLE  DEFAULT NULL AFTER `discount`;
